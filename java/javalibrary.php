...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-8">
	  ...
	  <p class="normal">In the Java API, the classes are grouped into packages.</p></br>
	  <p class="normal">To use a class in the API. you have to know which package the class Is in.</p></br>
	  <p class="normal">Every class in theJava library belongs to a package. The package has a name, like javax.swlng 
	  (a package that holds some ofthe Swing GUI classes you'll learn about soon). ArrayList is in the package called java.util,
	  which surprise surprise, holds a pile of utilityclasses<p class="normal"></br>
	  <p class="normal">Even if you didn't know it, you've already been using classesfrom a package. 
	  System (System.out.println), String, and Math (Math.random0), all belong to the java.lang package.</p></br>
	  <p class="normal">You have to know the full name* -of the class you want to use in your code.</p></br>
	  <p class="normal">You have to tell Java which ArrayList you want to use. You have two options:</br>
	  A.IMPORT</br>
	  Put an import statement at the top ofyour source code file: import java.util.ArrayList; public class MyClass {... }</p><br>
	  <p class="normal"> TYPE Type the full name everywhere in your code. Each time you use it. Anywhere you use it.</br>
