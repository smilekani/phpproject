...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <p><b>Understanding Inheritance</b></p></br>
	  <p>When you design with inheritance, you put common code in a class and then tell other more specific classes that the common
	  ...
	  <p><b>Java Inheritance Example</b></p>
...
void makeIncision() ( // make incision (yikes!)
	...
	<p><b>Note:</b></p></br>
	<p><b>If class B extends class A, class B IS-A class A.
